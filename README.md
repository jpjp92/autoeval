...
| 벡터화    | Gemini Embedding 2 (`gemini-embedding-2`) — **1536차원** 벡터 변환                                                                                  |
...
| **Embeddings**  | Gemini Embedding 2 (`gemini-embedding-2`) — 1536dim, HNSW 인덱스                                            |
...
| Embedding                       | Gemini Embedding 2 (`gemini-embedding-2`)         | 1536차원, 청크/쿼리별 task prefix 사용         |
